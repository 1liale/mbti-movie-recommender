...
export class IdentityStack extends Stack {
	...
	constructor(scope: Construct, id: string, props: IdentityStackProps) {
		...
		// Create an identity pool to grant access authorization
		const identityPool = new IdentityPool(this, `MBTIMoviesIdentityPool`, {
			identityPoolName: `MBTIMoviesIdentityPool`,
