import { APPSYNC_REGION, USERPOOL_ID, USERPOOL_CLIENTID, IDENTITYPOOL_ID, APPSYNC_GRAPHQL_URL, APPSYNC_AUTHENTICATION_TYPE, APPSYNC_API_KEY } from '$env/static/private';
