<script lang="ts">
    ...
    import { Button, Heading, Input, NavBrand, NavHamburger, NavLi, NavUl, Navbar, Span } from 'flowbite-svelte';
...
<Navbar color="form" let:hidden let:toggle>
    <NavBrand href="/">
        ...
        <Heading tag="h2" class="font-sans" customSize="xl:text-3xl md:text-3xl sm:text-xl font-extrabold dark:text-white">
