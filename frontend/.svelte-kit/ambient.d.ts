...
declare module '$env/static/private' {
	...
	export const USERPOOL_CLIENTID: string;
	export const IDENTITYPOOL_ID: string;
	export const APPSYNC_AUTHENTICATION_TYPE: string;
	export const APPSYNC_REGION: string;
	export const APPSYNC_API_ID: string;
	export const APPSYNC_API_KEY: string;
	export const APPSYNC_GRAPHQL_URL: string;
	...
	export const SSH_USER: string;
	export const ORIGINAL_XDG_CURRENT_DESKTOP: string;
	export const MallocNanoZone: string;
	export const npm_config_registry: string;
	export const npm_package_devDependencies__sveltejs_kit: string;
	export const npm_package_scripts_lint_svelte_check_ignore_gen: string;
	export const NVM_DIR: string;
	export const USER: string;
	export const npm_package_scripts_check_watch: string;
	export const COMMAND_MODE: string;
	export const PNPM_SCRIPT_SRC_DIR: string;
	export const npm_package_scripts_lint_prettier_fix: string;
	...
	export const REMOTE_PORT: string;
	...
	export const REMOTE_DOMAIN: string;
	export const npm_package_devDependencies_aws_amplify: string;
	export const npm_package_scripts_build: string;
	export const npm_package_scripts_lint_eslint: string;
	export const VSCODE_GIT_ASKPASS_EXTRA_ARGS: string;
	export const XPC_FLAGS: string;
	export const npm_package_devDependencies_flowbite_svelte: string;
	export const npm_package_scripts_lint_nowarns: string;
	export const npm_config_node_gyp: string;
	export const npm_package_devDependencies_eslint_config_prettier: string;
	export const npm_package_devDependencies__aws_amplify_api: string;
	export const npm_package_scripts_lint_eslint_nowarns: string;
	...
	export const npm_package_scripts_lint_prettier: string;
	...
	export const LAN_SERVER_ADDR: string;
	export const INFOPATH: string;
	export const HOMEBREW_CELLAR: string;
	export const npm_package_scripts_prepare: string;
	export const npm_package_scripts_lint_eslint_fix: string;
	export const npm_package_scripts_lint_svelte_check: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_scripts_lint_svelte_check_ignore_gen: string;
		NVM_DIR: string;
		USER: string;
		npm_package_scripts_check_watch: string;
		COMMAND_MODE: string;
		PNPM_SCRIPT_SRC_DIR: string;
		npm_package_scripts_lint_prettier_fix: string;
		...
		npm_package_devDependencies_aws_amplify: string;
		npm_package_scripts_build: string;
		npm_package_scripts_lint_eslint: string;
		VSCODE_GIT_ASKPASS_EXTRA_ARGS: string;
		XPC_FLAGS: string;
		npm_package_devDependencies_flowbite_svelte: string;
		npm_package_scripts_lint_nowarns: string;
		npm_config_node_gyp: string;
		npm_package_devDependencies_eslint_config_prettier: string;
		npm_package_devDependencies__aws_amplify_api: string;
		npm_package_scripts_lint_eslint_nowarns: string;
		...
		GIT_ASKPASS: string;
		LAN_SERVER_ADDR: string;
		INFOPATH: string;
		HOMEBREW_CELLAR: string;
		npm_package_scripts_prepare: string;
		npm_package_scripts_lint_eslint_fix: string;
		npm_package_scripts_lint_svelte_check: string;
